...
echo "<form name=f action=modifynotice2.php method=POST><table border=1 align=center><tr><th>Notice Id</th><th>Notice Date</th><th>Notice</th></tr>";
while($row=mysql_fetch_array($result))
{

if($_POST['sn3']==$row['noticeid'])
{
echo "<tr><td><input type=text name=t2 value='$row[noticeid]'></td><td><input type=text name=t3 value='$row[noticedate]'></td><td><input type=text name=t4 value='$row[notice]'></td></tr>";
$p=1;
}
}
echo "</table><div align=center><input type=submit value=Update></div></form>";
if($p==0)
echo"<table border=1 align=center><tr><td><font color=#0000ff> <b>No Record Found</b></font></td></tr></td>";
mysql_close($con);
?>
