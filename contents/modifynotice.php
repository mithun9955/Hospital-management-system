...
<div align="center">
  ...
  <table width="900" border="0" align="center" bgcolor="#FFFFFF">
    ...
    <tr>
      <td height="109">&nbsp;</td>
      <td><div align="center">
        <table width="376" border="0" bgcolor="#00ff99">
          <form name="f5" action="modifynotice1.php" method="post">
            <tr>
              <td width="115"><div align="right" class="style7">Enter Notice Id </div></td>
              <td width="10"><span class="style7">:-</span></td>
              <td colspan="2"><input type="text" name="sn3" id="sn3" size="30" maxlength="30"></td>
            </tr>
            <tr>
              <td>&nbsp;</td>
              <td>&nbsp;</td>
              ...
              <td width="120"><input type="reset" name="Submit2" value="Reset"></td>
            </tr>
          </form>
          <tr>
            <td>&nbsp;</td>
