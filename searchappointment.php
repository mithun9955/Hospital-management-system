...
.style46 {font-size: 18px; color: #FFFFFF; }
-->
</style>
...
&nbsp; <audio> <source src="abc.mp3" type="audio/mpeg" autostart="true"> </audio></td>
  ...
  <tr>
    ...
    <td width="75" valign="top" bgcolor="#003366"><div align="right" class="style37"><strong>Sign In </strong></div></td>
    <td width="79" valign="top" bgcolor="#003366"><div align="center"><span class="style37"><strong>Sign Up </strong></span></div></td>
  </tr>
</table>


<table width="1003" border="1" align="center" bordercolor="#6EA5F8" bgcolor="#003366">
  <tr>
    <td width="636"><div align="center" class="style46"><a href="admineform.php"><font color="#FFFFFF"> Back</font></a></div>
        <div align="center" class="style46"></div></td>
    <td width="351"><span class="style46"><a href="index.php"><font color="#FFFFFF">Home</font></a></span></td>
  </tr>
</table>
<p align="center">
                <?php
                 echo "<form name=fr action=searchappointment1.php method=POST>";
