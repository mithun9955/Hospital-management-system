...
<table width="999" height="133" align="center" background="images/paritranbg.png" bgcolor="#003366">
  <tr>
    ...
    <font color="#FFFFFF">    <p>WELCOME Mr.<?php if( session_id()!='')echo $_SESSION['usname'];?>
    </td>
  </tr> </p></td>
  </tr>
  <tr>
  ...
  <tr valign="top" bordercolor="#003366">
    ...
    <td width="257" valign="top" onmouseover="showmenu('hospital')" onmouseout="hidemenu('hospital')"><div align="center"><span class="style37">Patient Online Appointment Details </span>
            <table class="menu" id="hospital" width="190" background="images/menubg.jpg" border="2"  bordercolor="#999900" bgcolor="#003366">
              <tr>
                <td class="menu"> <a href="displayappointment.php"><font color="#FFFFFF">Display Record</font></a></td>
              </tr>
              <tr>
                <td class="menu"> <a href="searchappointment.php"><font color="#FFFFFF">Search Record</font></a></td>
              </tr>
              <tr>
                <td class="menu "> <a href="modifyappointment.php"><font color="#FFFFFF">Update Record</font></a></td>
              </tr>
              <tr>
                <td class="menu "> <a href="searchfordeleteappointment.php"><font color="#FFFFFF">Delete Record</font></a></td>
              </tr>
            </table>
    </div></td>
    <td width="176" valign="top" onmouseover="showmenu('gallery')" onmouseout="hidemenu('gallery')">
      <div align="center"><span class="style37"> <a href="newsevents.php"><font color="#FFFFFF">News &amp; events</font></a></span></div></td>
...
<table width="1007" height="184" border="0" align="center">
  <tr>
    <td width="1001"><img src="pcs/admin%201.jpg" width="1001" height="235"></td>
  </tr>
</table>
<br>
<br>
